...
#Region " Ações "
    ...
    Public Sub carregaEndereco()
        ...
        If totalLinhasEnd > 0 Then
            ...
            sigla = listaEnd.Tables("endereco").Rows(0)(2).ToString()
            endereco = listaEnd.Tables("endereco").Rows(0)(3).ToString()
