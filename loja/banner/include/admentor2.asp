...
Private Function AdMentor_GetAdEx( fASP, strZone, nFarm, nBannerId, nBannerOnPage, fCanUseHTML )
 ...
 extensao = Right(oRS("gifurl").Value, 4) 
    ...
    Else
    sRet="<center><embed src="&oRS("gifurl").Value&" quality=high WIDTH=468 HEIGHT=60 TYPE=application/x-shockwave-flash></center>"
    End If    
    '-----------------------------------
...
Public Function AdMentor_ClickAd(nBannerId, sWay)
    ...
    'Pretty easy...
    Set oConn = AdMentor_DBOpenConnection2("1")
