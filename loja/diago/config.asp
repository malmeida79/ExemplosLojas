...
StringdeConexao = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source="D:\Domains\compuwaretecno.com.br\db\bada.mdb";"
...
seu_cep = "12237-120"		'Digite o CEP de sua loja usando somente numeros
...
'## Dados da loja	
Nome_da_sua_loja = "Compuware Technologies"
CNPJ_da_sua_empresa = "00.000.000/0001-00"
Razao_Social = "Compuware Technologies"
Email_da_sua_loja = "conato@compuwaretecno.com.br"
...
Endereco_da_sua_loja = "Rua Onze de Agosto , N°79 "
...
mostrar_quadro_linguagens="Sim"	'--> 'Deixe "Sim" ou "Nao"
...
mostrar_pagamento_por_boleto="Nao" 'Deixe "Sim" para usar ou então escreva "Nao"
...
'###################################################################################
'	6.	CONFIGURAÇÕES DE PAGAMENTO VIA PAGSEGURO
'###################################################################################

'## Você deseja colocar a opção PagSeguro como Forma de Pagamento?
pagseguro_aceitar_pagamentos = "Sim" 'Deixe "Sim" para usar ou então escreva "Nao"

pagseguro_email = "email@email.com.br" 'Seu email cadastrado no PagSeguro
pagseguro_moeda = "BRL" 'Tipo de moeda que o seu site trabalha. (BRL = Brasil Real)

pagseguro_token = "" 'Digite o seu Token cadastrado no PagSeguro. Você poderá recuperar/gerar seu Token, através
'do menu "Meus Dados >> Retorno Automático"

pagseguro_aceitar_cartao_credito = "Sim" 'Deixe "Sim" caso você aceite pagamentos por cartão de crédito
'através do PagSeguro, ou escreva "Nao" caso você não aceite pagamentos por cartão de crédito pelo PagSeguro

pagseguro_tipo_calculo_frete = "1" 'Digite o tipo de cálculo de frete que você deseja que o PagSeguro calcule
...
pagseguro_tipo_frete = "" 'Digite o tipo de frete que você usa
'Você deverá configurar esta opção apenas se estiver utilizando na variável "pagseguro_tipo_calculo_frete"
'a opção número "3", e desejar sempre que o PagSeguro calcule por este tipo de frete
'**** OPÇÕES ****
