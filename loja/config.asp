...
StringdeConexao = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Server.MapPath("bada/bada.mdb")
...
seu_cep = "09607020"		'Digite o CEP de sua loja usando somente numeros
...
mostrar_contador="Nao"	'--> Coloque "Sim" se quiser mostrar
