...
strTextoHtml = strTextoHtml & "<br><br><center><strong><FONT face=tahoma color=#000000 style=font-size:11px>Abra o link abaixo para iniciar o seu atendimento on-line<P><a href=""sos/admin_login.asp"" target=""_blank"">Iniciar atendimento</a></strong></center>"
...
'########################################################
		...
		objStream.LoadFromFile Server.MapPath("bada/estatisticas.dat")
