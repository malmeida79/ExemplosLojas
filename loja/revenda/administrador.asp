...
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""?link=adm&acao=editar&acaba=sim"">Ver / Editar administrador</A></FONT></TD></TR>"
...
strTextoHtml = strTextoHtml & "<TR><TD colSpan=2><FONT face=tahoma style=font-size:11px>&nbsp;&nbsp;<IMG src=""adm_imagens/seta.gif"" border=0> &nbsp;<A href=""http://www.compuwaretecno.com.br/default.asp"" target=_novo_frame_vs>Ver  loja</A></FONT></TD></TR>"
